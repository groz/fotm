...
namespace FotM.Cassandra
{
    ...
    public class UpdatedKMeans
    {
        ...
        /// 
        public UpdatedKMeans(int k, Func<double[], double[], double> distance)
        {
    ...
    public class KMeansCluster
    {
        ...
        internal KMeansCluster(UpdatedKMeans owner, int index)
        {
            this.owner = owner;
            this.index = index;
        }
    ...
    public class KMeansClusterCollection : ReadOnlyCollection<KMeansCluster>
    {
        ...
        internal KMeansClusterCollection(UpdatedKMeans owner, IList<KMeansCluster> list)
            : base(list)
        {
            this.owner = owner;
        }
